...
import { useAdministratorsStore } from '@/views/admin/administrators/useAdministratorsStore'
import { avatarText } from '@core/utils/formatters'

const administratorListStore = useAdministratorsStore()
...
// 👉 Fetching users
const fetchUsers = () => {
  administratorListStore.fetchUsers({
    q: searchQuery.value,
...
const addNewUser = userData => {
  administratorListStore.addUser(userData)
...
const deleteUser = id => {
  administratorListStore.deleteUser(id)
