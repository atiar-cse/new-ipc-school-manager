        ...
        <VCard title="Parents Section">
          ...
          >
            ...
            <template #item.name="{ item }">
              <RouterLink :to="{ name: 'admin-parents-view-id', params: { id: item.raw.id } }">
                {{ item.raw.name }}
              </RouterLink>
            </template>
            ...
            <template #item.actions="{ item }">
              <IconBtn :to="{ name: 'admin-parents-edit-id', params: { id: item.raw.id } }">
                <VIcon icon="tabler-edit" />
              </IconBtn>

              <IconBtn :to="{ name: 'admin-parents-view-id', params: { id: item.raw.id } }">
              ...
              >
                ...
                <VMenu activator="parent">
                  <VList>
                    <VListItem :to="{ name: 'admin-parents-edit-id', params: { id: item.raw.id } }">
                      <template #prepend>
                    ...
                    <VListItem :to="{ name: 'admin-parents-view-id', params: { id: item.raw.id } }">
                      <template #prepend>
                        <VIcon icon="tabler-eye" />
                      </template>
