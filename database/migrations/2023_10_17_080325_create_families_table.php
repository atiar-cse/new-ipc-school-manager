...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('families', function (Blueprint $table) {
            ...
            $table->string('phone_o', 20)->nullable();
            $table->string('mobile_m', 20)->nullable();
            $table->string('mobile_f', 20)->nullable();
            ...
            $table->string('lr_phone_h', 20)->nullable();
            $table->string('lr_phone_w', 20)->nullable();
